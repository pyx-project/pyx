...
Walter Brisken, Jörg Lehmann, Michael Schindler, Gerhard Schmid, Andr{\'e} 
Wobst.
\newpage
...
\tipagraph{[pYks]}{tipa1.pdf}. Please do not pronounce it as 
\tipagraph{[pYx]}{tipa2.pdf} or \tipagraph{[pY\c c]}{tipa3.pdf}.
}
...
This will result in a subdirectory with a name like \texttt{PyX-0.6.3} which
...
\begin{progcode}
import sys\\
sys.path[:0]~=~["/home/xyz/Python/PyX-0.6.3"]
\end{progcode}
...
\begin{progcode}
import sys, os\\
sys.path[:0]~=~[os.path.expanduser("\char126/Python/PyX-0.6.3")]
\end{progcode}
...
%~~~~~~~~~~~~~~~~~~~~~~~~~~painter=graph.axis.painter.regular(gridattrs=[])\\
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~),\\
~~~~~~~~~~~~~~~~~~y=graph.axis.linear()\\
~~~~~~~~~~~~~~~~~~)
\end{progcode}
