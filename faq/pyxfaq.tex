...
\begin{progcode}
g.plot(graph.data("datafile.dat"), xmin=0, xmax=1, ymin=2, ymax=3, color=4),\\
~~~~~~~graph.rect(color.palette.ReverseRainbow)\\
~~~~~~)\\
g.dodata()
\end{progcode}
...
\begin{progcode}
g.plot(graph.data("datafile.dat"), x=0, y=1, size=2, angle=3),\\
~~~~~~~graph.arrow()\\
~~~~~~)
\end{progcode}
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~parter=graph.linparter(tickdist=[2,1]))\\
~~~~~~~~~~~~~~~~~~~)
\end{progcode}
}
