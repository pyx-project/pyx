...
{
To stroke a grid line at a special axis position, the graph needs to
be finished first (at least the layout needs to be fixed). Than you
can access special methods and variables of the graph instance to add
further information.
\begin{progcode}
g.finish()
