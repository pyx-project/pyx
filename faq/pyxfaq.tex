...
palette from one end to the other. In the following example, symbols vary in
form and change their color according to the rainbow palette at the same time
