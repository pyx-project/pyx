...
\begin{classdesc}{file}{filename, % {{{
  ...
  when evaluating mathematical expressions for columns. As an example
  you may use \code{context=locals()} or something similar.
...
\begin{classdesc}{function}{expression, title=notitle, % {{{
  ...
  \var{context} allows for accessing external variables and functions.
  As an example you may use \code{context=locals()} or something
  similar.
\end{classdesc} % }}}
