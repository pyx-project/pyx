...
\begin{classdesc}{arrow}{linelength=0.25*unit.v\_cm, % {{{
  ...
  the arrow is plotted at. When \var{arrowsize} is \code{None} only
  the line is stroked. \code{angle} is the angle the arrow points to
  with respect to a horizontal line. The \code{angle} is taken in
