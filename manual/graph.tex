...
\begin{classdesc}{impulses}{lineattrs=[], fromvalue=0, % {{{
  ...
  variable \code{changelinestyle} as described above. \var{fromvalue}
  is the baseline value of the impulses. When set to \code{None}, the
  impulses will start at the baseline. When fromvalue is set,
  \var{frompathattrs} are the stroke attributes used to show the
