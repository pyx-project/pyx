...
This module has a quite internal character, but might still be usefull
from the users point of view. It might also get further enhanced to
cover a broader range of standard problems in arranging content.

In the context of this module a box is a convex polygon having
optionally a center coordinate, which play an important role for the
box alignment. The center might not at all be central, but it should
be within the box. The convexity is postulated in order to keep the
...
these two numbers is unequal zero. No further assumptions are taken.
...
specialized class \verb|rect|. Its constructor takes at first four
parameters, namely the x, y position and the box width and height.
Addtionally, for the definition of the position of the center, two
...
meassured with respect to the lower left corner of the box. By
