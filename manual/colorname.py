...
for line in lines: # we yet don't use a file iterator
    ...
    if m:
        ...
        c.draw(path.line(x + 0.6, y + 0.1, x + 0.9, y + 0.4), color.gray.black)
        c.draw(path.line(x + 0.9, y + 0.1, x + 0.6, y + 0.4), color.gray.black)
        c.draw(path.line(x + 1.1, y + 0.1, x + 1.4, y + 0.4), color.gray.white)
        c.draw(path.line(x + 1.4, y + 0.1, x + 1.1, y + 0.4), color.gray.white)
