...
c.insert(graph.pathaxis(path.path(path.moveto(11, 0), path.lineto(11, 8)),
                        graph.linaxis(painter=graph.axispainter(tickattrs=color.rgb.red, innerticklengths=0, outerticklengths=graph.axispainter.defaultticklengths), **lintest),
                        direction=-1))
c.insert(graph.pathaxis(path.path(path.moveto(12, 0), path.lineto(12, 8)),
                        graph.linaxis(painter=graph.axispainter(tickattrs=(None, (color.rgb.green,))), **lintest)))
