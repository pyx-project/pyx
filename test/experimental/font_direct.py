...
c.writePDFfile("font_direct_text_as_path", write_text_as_path=True, write_compress=False)
c.writeSVGfile(write_text_as_path=False)
c.writeSVGfile("font_direct_text_as_path", write_text_as_path=True)
