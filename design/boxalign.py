...
c = canvas.canvas()
t = c.insert(tex.tex())
c.stroke(path.line(0, 0, 4, 2), canvas.earrow.Large)
graph.textbox(t, r"$\vec p$").linealign(0.1, -2/math.sqrt(20), 4/math.sqrt(20)).printtext(2, 1)
c.stroke(path.line(0, 0, 1, 1), canvas.earrow.Large)
graph.textbox(t, r"$\vec a$").linealign(0.1, -1/math.sqrt(2), 1/math.sqrt(2)).printtext(0.5, 0.5)
c.stroke(path.line(-1, 3, 3, -1), canvas.linestyle.dotted)
c.stroke(path.line(1, 1, 1-1/math.sqrt(2), 1+1/math.sqrt(2)), canvas.earrow.Large)
...
c.stroke(path.line(0, 0, -1, 1), canvas.earrow.Large)
graph.textbox(t, r"$\vec a$").linealign(0.1, -1/math.sqrt(2), -1/math.sqrt(2)).printtext(-0.5, 0.5)
c.stroke(path.path(path.arc(0, 0, math.sqrt(2), 0, 360), path.closepath()), canvas.linestyle.dotted)
...
c.stroke(path.line(0, 0, 6, 2), canvas.earrow.Large)
graph.textbox(t, r"$\vec f$").linealign(0.1, 2/math.sqrt(60), -6/math.sqrt(60)).printtext(3, 1)
c.stroke(path.line(6, 2, 4, 2), canvas.earrow.Large)
graph.textbox(t, r"$\vec g$").linealign(0.1, 0, 1).printtext(5, 2)
c.stroke(path.line(0, 0, -1, 1), canvas.earrow.Large)
graph.textbox(t, r"$\vec a$").linealign(0.1, -1/math.sqrt(2), -1/math.sqrt(2)).printtext(-0.5, 0.5)
c.stroke(path.path(path.arc(0, 0, math.sqrt(2), 0, 360), path.closepath()), canvas.linestyle.dotted)
c.stroke(path.line(0, 0, 0, math.sqrt(2)), canvas.earrow.Large)
