...
drawexample(sc, 1, 1)
t = c.insert(tex.tex())
t.text(0, 1.5*d, "align at circle", tex.halign.center)
t.text(d, 1.5*d, "align at line", tex.halign.center)
t.text(-0.5*d, d, "central point at the triangle center", tex.halign.center, tex.direction.vertical)
t.text(-0.5*d, 0, "central point at a triangle corner", tex.halign.center, tex.direction.vertical)
